...
<span class="token function">pnpm</span> <span class="token function">add</span> eslint --dev
...
<span class="token function">pnpm</span> create @eslit/config
...
</code></pre></div><p>\u8FD8\u53EF\u4EE5\u5728\u5168\u5C40\u800C\u4E0D\u662F\u672C\u5730\u5B89\u88C5 ESLint (\u4F7F\u7528 npm install ESLint \u2014\u2014 global)\u3002\u4F46\u662F\uFF0C\u4E0D\u5EFA\u8BAE\u8FD9\u6837\u505A\uFF0C\u800C\u4E14\u5728\u8FD9\u4E24\u79CD\u60C5\u51B5\u4E0B\uFF0C\u60A8\u4F7F\u7528\u7684\u4EFB\u4F55\u63D2\u4EF6\u6216\u53EF\u5171\u4EAB\u914D\u7F6E\u90FD\u5FC5\u987B\u5728\u672C\u5730\u5B89\u88C5\u3002</p><h2 id="\u914D\u7F6E" tabindex="-1">\u914D\u7F6E <a class="header-anchor" href="#\u914D\u7F6E" aria-hidden="true">#</a></h2>`,14),l=n("p",null,[s("\u5728\u8FD0\u884C npm init@eslint/config \u4E4B\u540E\uFF0C\u60A8\u5C06\u6709\u4E00\u4E2A\uFF0C"),n("code",{"js\uFF0Cyml\uFF0Cjson":""},".eslintrc"),s("\u6587\u4EF6\u3002\u5728\u5176\u4E2D\uFF0C\u60A8\u5C06\u770B\u5230\u4E00\u4E9B\u5982\u4E0B\u914D\u7F6E\u7684\u89C4\u5219:")],-1),i=a(`<div class="language-json"><pre><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>\u5728 ESLint \u4E2D\uFF0C\u540D\u79F0\u201C semi\u201D\u548C\u201C quote\u201D\u662F\u89C4\u5219\u7684\u540D\u79F0\u3002\u7B2C\u4E00\u4E2A\u503C\u662F\u89C4\u5219\u7684\u9519\u8BEF\u7EA7\u522B\uFF0C\u53EF\u4EE5\u662F\u4E0B\u5217\u503C\u4E4B\u4E00:</p><ul><li><code>&quot;off&quot;</code> or <code>0</code> - turn the rule off</li><li>\u201C\u5173\u95ED\u201D\u62160-\u5173\u95ED\u89C4\u5219</li><li><code>&quot;warn&quot;</code> or <code>1</code> - turn the rule on as a warning (doesn\u2019t affect exit code)</li><li>\u201C\u8B66\u544A\u201D\u62161-\u6253\u5F00\u89C4\u5219\u4F5C\u4E3A\u8B66\u544A(\u4E0D\u5F71\u54CD\u9000\u51FA\u4EE3\u7801)</li><li><code>&quot;error&quot;</code> or <code>2</code> - turn the rule on as an error (exit code will be 1)</li><li>\u201C error\u201D\u62162-\u5C06\u89C4\u5219\u4F5C\u4E3A\u9519\u8BEF\u6253\u5F00(\u9000\u51FA\u4EE3\u7801\u4E3A1)</li></ul><p>\u8FD9\u4E09\u4E2A\u9519\u8BEF\u7EA7\u522B\u5141\u8BB8\u60A8\u5BF9 ESLint \u5982\u4F55\u5E94\u7528\u89C4\u5219\u8FDB\u884C\u7EC6\u7C92\u5EA6\u63A7\u5236(\u6709\u5173\u66F4\u591A\u914D\u7F6E\u9009\u9879\u548C\u8BE6\u7EC6\u4FE1\u606F\uFF0C\u8BF7\u53C2\u9605<a href="https://eslint.org/docs/latest/user-guide/configuring/" target="_blank" rel="noopener noreferrer">configuration docs</a>)\u3002</p><p>\u60A8\u7684. eslintrc.{ js\uFF0Cyml\uFF0Cjson }\u914D\u7F6E\u6587\u4EF6\u8FD8\u5C06\u5305\u542B\u4EE5\u4E0B\u884C:</p><div class="language-shell"><pre><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>\u56E0\u4E3A\u6709\u4E86\u8FD9\u4E00\u884C\uFF0C\u89C4\u5219\u9875\u9762\u4E0A\u6807\u8BB0\u4E3A\u201C(\u63A8\u8350)\u201D\u7684\u6240\u6709\u89C4\u5219\u90FD\u5C06\u88AB\u6253\u5F00\u3002\u6216\u8005\uFF0C\u60A8\u53EF\u4EE5\u4F7F\u7528\u5176\u4ED6\u4EBA\u901A\u8FC7\u5728 npmjs. com \u4E0A\u641C\u7D22\u201C eslint-config\u201D\u521B\u5EFA\u7684\u914D\u7F6E\u3002\u9664\u975E\u4ECE\u5171\u4EAB\u914D\u7F6E\u8FDB\u884C\u6269\u5C55\uFF0C\u6216\u8005\u5728\u914D\u7F6E\u4E2D\u663E\u5F0F\u6253\u5F00\u89C4\u5219\uFF0C\u5426\u5219 ESLint \u5C06\u4E0D\u4F1A\u5BF9\u4EE3\u7801\u8FDB\u884C lint\u3002</p><h2 id="\u5B9E\u6218\u5C0F\u7EC3\u4E60" tabindex="-1">\u5B9E\u6218\u5C0F\u7EC3\u4E60 <a class="header-anchor" href="#\u5B9E\u6218\u5C0F\u7EC3\u4E60" aria-hidden="true">#</a></h2><ul><li>\u4FEE\u6539<code>.eslintrc</code>\u914D\u7F6E</li></ul><div class="language-json"><pre><code><span class="token punctuation">{</span>
